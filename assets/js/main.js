...
/*    $('body').scrollspy({ target: '#header', offset: 100});*/
    ...
    var target_date = new Date("September 04, 2016").getTime();
...
/*    map = new GMaps({
    ...
    map.addMarker({
        ...
        infoWindow: {
            content: '<div class="note">Ceremony</div><h4 class="map-title script">Chapel on the Hill</h4><div class="address"><span class="region">Batulao, Nasugbu, Batangas</span></div>'
        }
